...
// 75+ messages to handle analyses that take 2-3+ minutes on super active wallets
const LOADING_MESSAGES = [
  ...
  // Phase 3: Getting Curious (24-40 seconds)
  ...
  // Phase 4: Increasingly Casual (40-60 seconds)
  ...
  // Phase 5: Perplexed (60-90 seconds)
  ...
  "Recalculating... just to be sure",
  "The numbers are numbering...",

  // Phase 6: Extended Wait (90-120 seconds)
  "You really went through it huh",
  "This is more trades than I expected",
  "Building a comprehensive diagnosis...",
  "Your wallet is... a journey",
  "Still going. You've been busy.",
  "I've seen things. Many things.",
  "Adding extra detail to your roast...",
  "Trust the process...",

  // Phase 7: Deep Analysis (120-150 seconds)
  "Okay we're in deep analysis mode now",
  "Your trading history is a novel",
  "Chapter 47: The Revenge Trade",
  "Still finding more data...",
  "Did you sleep in 2024?",
  "Mapping the emotional rollercoaster...",
  "Peak degen behavior detected",
  "Calibrating roast intensity...",

  // Phase 8: AI Having Thoughts (150-180 seconds)
  "I need a minute to process this",
  "Consulting my training data...",
  "This is genuinely impressive volume",
  "You and Jupiter are close friends huh",
  "Found the ape, looking for the exit plan",
  "So many tokens. So many stories.",
  "Your PnL chart is... abstract art",
  "Almost there. Probably. Maybe.",

  // Phase 9: Philosophical (180-210 seconds)
  "At what point does trading become cardio",
  "Pondering your life choices (and mine)",
  "This analysis is becoming self-aware",
  "We're both learning things today",
  "Questioning the nature of alpha...",
  "Is this trading or performance art?",
  "Your wallet has main character energy",
  "Compiling the saga...",

  // Phase 10: Home Stretch (210-240 seconds)
  "Final calculations in progress...",
  "Putting the finishing touches on your roast",
  "Double-checking my math (for your sake)",
  ...
  // Phase 11: Extended Extended Wait (240+ seconds)
  "Okay this is a LOT of trades",
  "Still here. Still crunching.",
  "Your dedication to trading is noted",
  "Making sure I didn't miss anything",
  "The algorithm is sweating",
  "You might be our most active user",
  "Writing a dissertation at this point",
  "Hindsight has never seen this much hindsight",
  "Finalizing... seriously this time",
  "Any second now...",
  "Loading complete confidence...",
  "Ready to change your life (or ruin your day)",
  "Here it comes...",
  "Drumroll please...",
  "The moment of truth approaches...",

  // Phase 12: If we're STILL going (300+ seconds)
  "I genuinely didn't expect to still be here",
  "Your wallet broke my expectations",
  "This is unprecedented",
  "Are you a trading bot? Serious question",
  "My creators didn't prepare me for this",
  "Recalculating everything one more time",
  "This analysis will be worth it. Probably.",
  "Even I'm curious what the results say now",
  "The suspense is killing both of us",
  "Final final final stretch...",
  "If you're reading this, thanks for your patience",
  "Loading... (I know, I know)",
  "Still working. Haven't given up on you.",
  "Your results are going to be DETAILED",
    ...
    <section className="loop-section" id="loop-section">
      <div className="section-container">
        ...
        <div className="loop-cta-wrapper">
          <button onClick={() => onShowAuth('signup')} className="loop-cta">
            Enter the loop
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M5 12h14M12 5l7 7-7 7" />
            </svg>
