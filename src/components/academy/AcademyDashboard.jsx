...
function MostRequestedCard({ request, hasVoted, onVote, isVoting, rank }) {
  return (
    <div className={`most-requested-card ${rank <= 3 ? 'top-ranked' : ''}`}>
      <div className="most-requested-card-content">
        <div className="most-requested-rank-badge">
          {rank === 1 && <span className="rank-medal gold">🥇</span>}
          {rank === 2 && <span className="rank-medal silver">🥈</span>}
          {rank === 3 && <span className="rank-medal bronze">🥉</span>}
          {rank > 3 && <span className="rank-number">#{rank}</span>}
        </div>
        <div className="most-requested-info">
          <h4 className="most-requested-topic">{request.topic}</h4>
          <span className="most-requested-votes">
        ...
        <section className="most-requested-section">
          <div className="most-requested-header">
            ...
            <div>
              ...
              <p className="most-requested-subtitle">Vote for topics you want to learn</p>
            </div>
            <Link to="/academy/course-requests" className="most-requested-view-all">
              View All
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M5 12h14M12 5l7 7-7 7" />
              </svg>
          ...
          <div className="most-requested-grid">
            {topRequests.slice(0, 4).map((request, index) => (
              <MostRequestedCard
                key={request.id}
                request={request}
      ...
      <div className="coming-soon-footer-cta">
        <div className="footer-cta-content">
          ...
          <div className="footer-cta-text">
            <h4>Help shape upcoming courses</h4>
            <p>Join the community to discuss topics and suggest new content</p>
          </div>
        </div>
        <a
          href="https://discord.gg/fQjx6NBHTz"
