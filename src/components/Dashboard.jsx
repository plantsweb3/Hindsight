  ...
  return (
    <div className="xp-popup-overlay" onClick={onClose}>
      <div className="xp-popup" onClick={e => e.stopPropagation()}>
        ...
        <a href="/academy?scrollTo=leaderboard" className="xp-popup-link">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="copilot-cta-section">
              ...
              <a href="https://discord.gg/CNNpe3vyvv" target="_blank" rel="noopener noreferrer" className="copilot-cta-card discord-cta">
